package com.yeyu.dearinformaton.adapter.zhihu;
...
public class MainNewsItemAdapter extends BaseAdapter {
    ...
    public MainNewsItemAdapter(Context context) {
        ...
        options = new DisplayImageOptions.Builder()
                ...
                .cacheOnDisk(true)
                .build();
        isLight = ((ZhihuActivity) context).isLight();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.zhihu_news_item, parent, false);
        ...
        if (entity.getType() == zhihuConstant.TOPIC) {
