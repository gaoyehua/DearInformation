...
import com.yeyu.dearinformaton.utils.DimenUtil;
import com.yeyu.dearinformaton.widget.RatioImageView;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_FOOTER:
                ...
                return new BaseRecyclerViewAdapter.FooterViewHolder(view);
            case TYPE_ITEM:
