...
import com.yeyu.dearinformaton.adapter.NewsListAdapter;
...
import com.yeyu.dearinformaton.presenter.impl.NewsListPresenterImpl;
...
public class NewsListFragment extends BaseFragment implements NewsListView, NewsListAdapter.OnNewsListItemClickListener,
    ...
    private void initValues() {
        if (getArguments() != null) {
            mNewsId = getArguments().getString(Constant.NEWS_ID);
            mNewsType = getArguments().getString(Constant.NEWS_TYPE);
        }
    }
    ...
    private void startActivity(View view, Intent intent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ActivityOptions options = ActivityOptions
                    .makeSceneTransitionAnimation(mActivity, newsSummaryPhotoIv, Constant.TRANSITION_ANIMATION_NEWS_PHOTOS);
