...
import com.yeyu.dearinformaton.presenter.impl.NewsDetailPresenterImpl;
...
import com.yeyu.dearinformaton.widget.URLImageGetter;
...
//        mProgressBar.setVisibility(View.GONE);
    ...
    private void openByWebView() {
        ...
        intent.putExtra(Constant.NEWS_LINK, mShareLink);
        intent.putExtra(Constant.NEWS_TITLE, mNewsTitle);
