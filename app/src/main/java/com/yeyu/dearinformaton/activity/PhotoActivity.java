...
import com.yeyu.dearinformaton.adapter.PhotoListAdapter;
import com.yeyu.dearinformaton.entity.PhotoGirl;
import com.yeyu.dearinformaton.listener.OnItemClickListener;
import com.yeyu.dearinformaton.presenter.impl.PhotoPresenterImpl;
...
public class PhotoActivity extends BaseActivity implements
        PhotoView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void setAdapterItemClickEvent() {
        mPhotoListAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra(Constant.PHOTO_DETAIL, mPhotoListAdapter.getList().get(position).getUrl());
    ...
    private void startActivity(View view, Intent intent) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ActivityOptions options = ActivityOptions
                    .makeSceneTransitionAnimation(mActivity, view, Constant.TRANSITION_ANIMATION_NEWS_PHOTOS);
