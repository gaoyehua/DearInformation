...
import com.yeyu.dearinformaton.Constant.zhihu.Content;
...
import com.yeyu.dearinformaton.View.zhihu.RevealBackgroundView;
import com.yeyu.dearinformaton.db.WebCacheDbHelper;
 ...
 */
public class LatestContentActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (HttpUtils.isNetworkConnected(this)) {
            HttpUtils.get(zhihuConstant.CONTENT + entity.getId(), new TextHttpResponseHandler() {
                @Override
    ...
    private void setupRevealBackground(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            final int[] startingLocation = getIntent().getIntArrayExtra(zhihuConstant.START_LOCATION);
