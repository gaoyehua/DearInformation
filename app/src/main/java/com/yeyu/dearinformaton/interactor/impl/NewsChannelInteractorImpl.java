...
import com.yeyu.dearinformaton.interactor.NewsChannelInteractor;
...
public class NewsChannelInteractorImpl implements NewsChannelInteractor<Map<Integer, List<NewsChannelTable>>> {
    ...
    private Map<Integer, List<NewsChannelTable>> getNewsChannelData() {
        ...
        map.put(Constant.NEWS_CHANNEL_MINE, channelListMine);
        map.put(Constant.NEWS_CHANNEL_MORE, channelListMore);
        return map;
    }
